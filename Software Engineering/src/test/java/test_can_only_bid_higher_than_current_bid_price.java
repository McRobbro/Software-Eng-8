...
public class test_can_only_bid_higher_than_current_bid_price {
    ...
    @Test
    public void test_can_bid_higher_than_currentBidPrice() {
        ...
        bidRepository.makeBid(1, dummyUser1, auctionRepository.getSpecificAuction("dummySlug", "prodSlug"), 1000);

        assertNotNull(bidRepository.makeBid(2, dummyUser2, auctionRepository.getSpecificAuction("dummySlug", "prodSlug"), 1100));
